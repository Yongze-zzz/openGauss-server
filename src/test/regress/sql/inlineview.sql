...
\c -
GRANT DELETE, UPDATE ON emp TO usr1;
ALTER SESSION SET SESSION AUTHORIZATION usr1 PASSWORD '1234@abcd';
DELETE FROM (SELECT sal FROM emp) WHERE sal < 3000;
UPDATE (SELECT sal FROM emp) SET sal = 3000 WHERE sal < 3000;

\c -
REVOKE ALL PRIVILEGES ON emp FROM usr1;
GRANT SELECT ON emp TO usr1;
ALTER SESSION SET SESSION AUTHORIZATION usr1 PASSWORD '1234@abcd';
DELETE FROM (SELECT sal FROM emp) WHERE sal < 3000;
UPDATE (SELECT sal FROM emp) SET sal = 3000 WHERE sal < 3000;
...
DELETE FROM (SELECT sal FROM emp NATURAL JOIN dept) WHERE sal < 3000;
\c -
GRANT SELECT ON dept TO usr1;
ALTER SESSION SET SESSION AUTHORIZATION usr1 PASSWORD '1234@abcd';
DELETE FROM (SELECT sal FROM emp NATURAL JOIN dept) WHERE sal < 3000;

\c - 
GRANT DELETE ON dept TO usr1;
BEGIN;
SELECT COUNT(*) FROM emp NATURAL JOIN dept WHERE sal < 3000;
DELETE FROM (SELECT sal FROM emp NATURAL JOIN dept) WHERE sal < 3000;
SELECT COUNT(*) FROM emp NATURAL JOIN dept WHERE sal < 3000;
ROLLBACK;

\c -
REVOKE ALL PRIVILEGES ON dept FROM usr1;
REVOKE ALL PRIVILEGES ON emp FROM usr1;
DROP USER usr1;
